<?php
/** Plugin Author **/
$lc_author = 'www.zan3.com';
$lc_authorurl = 'http://www.zan3.com/';
$lc_plugin = 'Baidu Sitemap Generator';
$lc_pluginversion = '1.31';
$lc_pluginurl = 'http://www.zan3.com';
...
function Lc_expand_option() {
	...
	?>
        ...
        <tr><td><label for="lc_support"><?php _e('Support Author','baidu_sitemap');?></label></td><td><input type="checkbox" id="lc_support" name="lc_support" value="yes" <?php if($lc_support=='yes'){ echo 'checked="checked"'; } ?> /></td><td><a title="<?php _e('在wp_footer添加www.zan3.com的链接。谢谢！','baidu_sitemap');?>">[?]</a><td></tr>
