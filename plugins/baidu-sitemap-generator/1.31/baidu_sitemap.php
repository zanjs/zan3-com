...
function lc_text(){
	...
	<p>提醒：百度的站长平台也快有了（http://sitemap.baidu.com/），目前是在<b>封闭测试期间，将不对外开放</b>。也就是说，等这个开放后，百度将支持通用的sitemap了。 也就是说， 这个插件的使命就要告一段落了，或是结束更新，或是继续根据百度站长平台的要求继续开发插件。请大家提些建议~（建议：http://www.zan3.com/）</p>
	<?php
}
...
function the_lc_support(){
	...
	if($lc_support == 'yes'){
		print '<!-- Baidu Sitemap Generator by www.zan3.com -->';
	}
}
